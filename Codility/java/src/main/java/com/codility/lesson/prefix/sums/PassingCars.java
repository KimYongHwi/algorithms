...
public class PassingCars {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("example: " + p.solution(new int[]{0, 1, 0, 1, 1}));
        System.out.println("extreme_single1: " + p.solution(new int[]{0}));
        System.out.println("extreme_single2: " + p.solution(new int[]{1}));
        System.out.println("double1: " + p.solution(new int[]{1, 1}));
        System.out.println("double2: " + p.solution(new int[]{0, 0}));
